...
import { mintTransferBurnScenarios, scenarioMemo } from '../../data/scenarios/transaction-scenarios';
import { MintWorkflowPage } from '../../pages/MintWorkflowPage';

test.skip(
  process.env.OPSUI_RUN_MUTATING_TESTS !== 'true',
  'Mint-transfer-burn workflow creates live transaction data. Run with OPSUI_RUN_MUTATING_TESTS=true.'
);

for (const scenario of mintTransferBurnScenarios) {
